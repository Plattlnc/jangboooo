// 자사(협력사) 주간 프로모션 — 2026-08-13 갱신 스펙.
// 매주(수요일 시작, sla 주간과 동일) 초기화. 완료 100건 초과분(101건째부터)
// 1건당 +2,000원 지급. 예: 200건 → (200-100) × 2,000 = 200,000원.
// 기준 건수 = 주간 완료 합계 중 SLA 운영시간(09:00~24:00) 내 완료 (시간 외 0~8시 제외 — 호출부에서 차감).
// 클라이언트 안전(순수 계산) — 홈 카드가 사용.

export const PROMO_WEEKLY_THRESHOLD = 100;
