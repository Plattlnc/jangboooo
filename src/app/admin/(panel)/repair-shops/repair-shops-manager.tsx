...
export function RepairShopsManager({ shops }: Props) {
  ...
  return (
    <>
      ...
      <form
        onSubmit={onAdd}
        className="mt-1.5 rounded-[12px] border border-jb-line bg-white px-[13px] py-[11px] shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_1px_2px_0_rgba(0,0,0,0.04)]"
      >
      ...
      <div className="mt-3 space-y-2">
        {shops.length === 0 ? (
          <div className="rounded-[12px] border border-jb-line bg-white px-[13px] py-7 text-center shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_1px_2px_0_rgba(0,0,0,0.04)]">
          ...
          shops.map((s) => (
            <div
              key={s.id}
              className="rounded-[12px] border border-jb-line bg-white px-[13px] py-[11px] shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_1px_2px_0_rgba(0,0,0,0.04)]"
            >
