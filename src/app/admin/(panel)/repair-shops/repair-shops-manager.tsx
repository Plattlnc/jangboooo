...
export function RepairShopsManager({ shops }: Props) {
  ...
  const inputCls =
    "w-full rounded-[11px] border border-jb-line bg-[#f8f9fb] px-3 py-[9px] text-[13.5px] font-semibold text-jb-ink outline-none transition-colors placeholder:font-normal placeholder:text-[#b0b6c3] focus:border-jb-indigo focus:bg-white";
    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="mt-2.5 flex w-full items-center justify-center gap-1.5 rounded-[11px] bg-jb-indigo py-[11px] text-[13px] font-bold text-white transition-transform active:scale-[.98] disabled:opacity-50"
        >
            ...
            >
              ...
              <div className="mt-2 flex gap-1.5">
                <button
                  ...
                  disabled={pending}
                  onClick={() => onToggle(s)}
                  className="flex-1 rounded-[9px] border border-jb-line bg-white py-[7px] text-[11.5px] font-bold text-jb-ink-soft transition-transform active:scale-[.98] disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={pending}
                  onClick={() => onDelete(s)}
                  className="flex-1 rounded-[9px] border border-[#f5d2cf] bg-jb-red-tint py-[7px] text-[11.5px] font-bold text-jb-red transition-transform active:scale-[.98] disabled:opacity-50"
                >
                  삭제
                </button>
              </div>
