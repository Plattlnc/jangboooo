    ...
    <div className="px-3.5 py-3">
      ...
      <div className="mt-1.5 grid grid-cols-3 gap-[7px]">
        {[
          ...
          { label: "통합 거절률", value: fmtPct(view.totals.rejectionRate), color: "#f04452" },
          { label: "SLA 점수", value: view.totals.slaScore == null ? "—" : `${view.totals.slaScore}`, color: "#3182f6" },
        ].map((c) => (
          <div key={c.label} className="rounded-[18px] border border-jb-line bg-jb-card px-2 py-2.5 text-center shadow-[var(--toss-shadow)]">
          ...
          {byRejectDesc.length === 0 ? (
            ...
            byRejectDesc.map((r, i) => (
              ...
              >
                ...
                <span className="tnum w-[52px] text-right text-[13px] font-black text-[#f04452]">
