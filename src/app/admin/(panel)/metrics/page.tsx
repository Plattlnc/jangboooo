    ...
    <div className="px-3.5 py-[9px]">
      ...
      <div className="mt-1.5 grid grid-cols-3 gap-[7px]">
        {[
          ...
          <div key={c.label} className="rounded-[12px] border border-jb-line bg-white px-2 py-2.5 text-center shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_1px_2px_0_rgba(0,0,0,0.04)]">
