...
export default async function AdminGoalsPage({
  ...
  return (
    <div className="px-3.5 py-3">
      ...
      {/* 오늘(영업일) 현황 — 실시간 수집분 */}
      <div className="mt-1.5 rounded-[12px] border border-jb-line bg-white px-[13px] py-[9px] shadow-[0_1px_2px_0_rgba(0,0,0,0.04)]">
        {latest.length === 0 ? (
      ...
      <div className="mt-3">
        ...
        />
        {history.length === 0 ? (
          <div className="mt-1.5 rounded-[12px] border border-jb-line bg-white px-4 py-6 text-center text-[12px] font-bold text-jb-ink-mute shadow-[0_1px_2px_0_rgba(0,0,0,0.04)]">
            선택한 기간에 수집된 공동목표가 없어요
          </div>
        ) : (
          <div className="mt-1.5 rounded-[12px] border border-jb-line bg-white shadow-[0_1px_2px_0_rgba(0,0,0,0.04)]">
