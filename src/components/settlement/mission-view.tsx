...
// 본사 미션 정산 뷰 — 선택일 라이더별 본사 미션(세전)에서 원천세·고용산재 공제 → 지급액.
// 수수료(완료건당 100원) 미적용. 메모·특이사항은 일일정산과 동일 저장 데이터(라이더 귀속).
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-[13px] text-jb-ink-mute">
          본사 미션 지급액(세전)에서 원천세 {WHT_PCT} · 고용산재 {INS_PCT} 공제 후 지급액. 수수료는 미적용(배달처리비 전용).
        </p>
