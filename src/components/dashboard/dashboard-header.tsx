...
// 03 §A. 인사 + 마지막 갱신 + 테마 토글. 카피 SSOT: docs/copy/dashboard.md §1.
  ...
  return (
    <header className="flex items-start justify-between gap-2">
      <div className="flex flex-col gap-1">
        ...
        <p className="flex items-center gap-1.5 text-caption text-muted-foreground" aria-live="polite">
          <span
            aria-hidden="true"
            className={cn(
        ...
        <p className="text-caption text-muted-foreground/70">기록은 1분마다 자동으로 새로워져요</p>
      </div>
